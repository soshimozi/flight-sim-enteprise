...
<%
    ...
    boolean isPrivate = request.getParameter("action") != null; //.contains("privatesale");
%>
...
<head>
    ...
    <script type="text/javascript">
        ...
        {
            document.location.href = "fbosforsale.jsp";
        }
...
<%
    ...
    {
%>
            <button class="btn btn-info form-control" onclick="loadOpenSales()"> View Open Sale Offers</button>
<%
    }
    else
    {
%>
            ...
            note: Create a private sale on the FBO edit page.
<%
    }
%>
        </div>
        <div class="dataTable">
            <form method="post" action="userctl" name="fboForm">
                ...
                <table class="fboTable tablesorter-default tablesorter">
                    <caption><%=isPrivate ? "Private FBO Sale Offers" : "FBOs for sale"%>
...
<%
    ...
    if(isPrivate)
        fbos = Fbos.getFboForSale(user.getId());
    else
        fbos = Fbos.getFboForSale();
